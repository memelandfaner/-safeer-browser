...
In scope: the Safeer browser for Android, its ad and threat blocking, the DNS-over-HTTPS
proxy, Safeer Link and Safeer Cast, and anything that handles pages or keys on
the device.
