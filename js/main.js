...
const i18n = {
  sl: {
    ...
    badge_active: "Safeer v1.0.6 — Stable Release • Target SDK 36",
    ...
    btn_linux_text: "Prenesi za Linux Mint (.deb 1.3 MB)",
    ...
    dl_btn_mob: "Prenesi mobilni brskalnik APK (2.5 MB)",
    ...
    dl_btn_desktop: "Prenesi .deb paket (1.3 MB)",
  ...
  en: {
    ...
    btn_linux_text: "Download for Linux Mint (.deb 1.3 MB)",
    ...
    dl_btn_mob: "Download Mobile Browser APK (2.5 MB)",
    ...
    dl_btn_desktop: "Download .deb package (1.3 MB)",
  ...
  de: {
    ...
    btn_linux_text: "Für Linux Mint herunterladen (.deb 1.3 MB)",
    ...
    dl_btn_mob: "Mobilen Browser APK herunterladen (2.5 MB)",
    dl_tv_h3: "📺 TV Browser (Smart Android TV)",
    ...
    dl_btn_desktop: ".deb-Paket herunterladen (1.3 MB)",
  ...
  es: {
    ...
    btn_linux_text: "Descargar para Linux Mint (.deb 1.3 MB)",
    ...
    dl_btn_mob: "Descargar Navegador Móvil APK (2.5 MB)",
    ...
    dl_btn_desktop: "Descargar paquete .deb (1.3 MB)",
  ...
  fr: {
    ...
    dl_btn_mob: "Télécharger le Navigateur Mobile APK (2.5 Mo)",
  ...
  it: {
    ...
    btn_linux_text: "Scarica per Linux Mint (.deb 1.3 MB)",
    tab_mob: "📱 Smartphone (Galaxy S25)",
    tab_tv: "📺 TV 4K",
    ...
    dl_btn_mob: "Scarica Browser Mobile APK (2.5 MB)",
    ...
    dl_btn_desktop: "Scarica pacchetto .deb (1.3 MB)",
...
const screenshotData = {
  ...
  desktop: {
    main: {
      ...
      url: 'safeer://home',
      status: 'Linux Mint v1.0.11',
      icon: '🍃',
      caption: '<strong>Linux Mint &amp; Ubuntu Izdaja v1.0.11:</strong> Nativni GTK3/WebKit2GTK brskalnik z vrstico zaznamkov (Ctrl+Shift+B), DuckDuckGo privzeto, čarovnikom ob prvem zagonu in 0 oglasov na YouTube.'
    }
  }
};
