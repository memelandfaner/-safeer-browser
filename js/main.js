...
const i18n = {
  sl: {
    ...
    tr3_safeer: "<span style=\"color:#10b981;\">✓</span> Blokada oglasov",
    ...
    badge_yt: "Blokada oglasov • Ozadje",
    ...
    linux_quote_text: "»Safeer je ultra lahek, energetsko varčen Linux brskalnik, ki se odpre v pol sekunde, porabi 3-krat manj RAM-a kot Chrome/Firefox in ima vgrajen predvajalnik brez oglasov ter lokalni ščit pred zlonamernimi domenami.«",
  ...
  en: {
    ...
    tr3_safeer: "<span style=\"color:#10b981;\">✓</span> Ad-blocking",
    ...
    card1_title: "Screen-Off YouTube. Ad-blocking.",
    ...
    linux_quote_text: "“Safeer is an ultra-lightweight, energy-efficient Linux browser that opens in half a second, consumes 3 times less RAM than Chrome/Firefox, and features a built-in zero-ad player plus a local malware threat shield.”",
  ...
  de: {
    ...
    tr3_safeer: "<span style=\"color:#10b981;\">✓</span> Werbeblocker",
    ...
    linux_quote_text: "„Safeer ist ein ultra-leichter, energieeffizienter Linux-Browser, der in einer halben Sekunde startet, 3-mal weniger RAM verbraucht als Chrome/Firefox und einen integrierten werbefreien Player sowie einen lokalen Schadsoftware-Schutz bietet.“",
  ...
  es: {
    ...
    tr3_safeer: "<span style=\"color:#10b981;\">✓</span> Bloqueo de anuncios",
    ...
    linux_quote_text: "«Safeer es un navegador Linux ultra ligero y de bajo consumo energético que abre en medio segundo, consume 3 veces menos RAM que Chrome/Firefox e integra un reproductor sin anuncios y escudo local contra malware.»",
  ...
  fr: {
    ...
    tr3_safeer: "<span style=\"color:#10b981;\">✓</span> Blocage des pubs",
    ...
    linux_quote_text: "« Safeer est un navigateur Linux ultra-léger et économe en énergie qui démarre en une demi-seconde, consomme 3 fois moins de RAM que Chrome/Firefox et dispose d'un lecteur sans pub intégré ainsi que d'un bouclier anti-malware local. »",
  ...
  it: {
    ...
    tr3_safeer: "<span style=\"color:#10b981;\">✓</span> Blocco annunci",
    ...
    linux_quote_text: "«Safeer è un browser Linux ultra-leggero a basso consumo energetico che si apre in mezzo secondo, consuma 3 volte meno RAM di Chrome/Firefox e integra un lettore senza pubblicità e uno scudo antimalware locale.»",
...
const showcaseCaptionsI18n = {
  ...
  "en": {
    "mobile": {
      ...
      "youtube": {
        "status": "Ad-blocking • Background",
        "caption": "<strong>Screen-Off YouTube:</strong> Uninterrupted music and podcasts in the background with locked screen and ad-blocking."
      }
    },
    "tv": {
      "home": {
...
const screenshotData = {
  ...
  desktop: {
    main: {
      ...
      icon: '🍃',
      caption: '<strong>Linux Mint &amp; Ubuntu Izdaja v1.0.7:</strong> Nativni GTK3/WebKit2GTK brskalnik z vrstico zaznamkov (Ctrl+Shift+B), DuckDuckGo privzeto, čarovnikom ob prvem zagonu in napredno blokado oglasov na YouTube.'
    }
  }
};
